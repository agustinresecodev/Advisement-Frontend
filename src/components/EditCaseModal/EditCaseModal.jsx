...
export const EditCaseModal = ({ showEdit,handleEditClose, handleSeeEdit, caseData, handleEditModal, editCase, clientFilter, techFilter, filteredClients, filteredTechs, handlerClientChange, handlerTechChange }) => {
return (
<Modal
size="lg"
show={showEdit}
